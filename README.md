...
We compared several regression approaches:

- Stepwise AIC regression
- Stepwise BIC regression
- Lasso regression
- Ridge regression

The project includes exploratory data analysis, feature engineering, diagnostic testing, and model comparison.
